...
def normalise_input(user_input):
    ...
    """
    # Remove punctuation, convert to lower case and remove extra spaces
    normalised = remove_punct(user_input).lower().split()

    # Returning a list of filtered words
    return filter_words(normalised, skip_words)